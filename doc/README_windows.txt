...
Setup
-----
Unpack the files into a directory and run botcoin-qt.exe.

If you have Microsoft Security Essentials, you need to add botcoin.exe to its
"Excluded processes" list.  Microsoft Security Essentials->Settings tab,
select Excluded processes, press Add, select botcoin.exe, OK, Save changes.
